...
- 挪车二维码可以自己将前端地址```http://<你的服务器IP>/```通过 [草料二维码](https://cli.im/url "点击跳转") 生成，如果想自己设计也无需专业设计软件，打开**PPT**做一个就行，参加```imgs```文件夹中的PPT模板```停车码.pptx```。
 ...
 <img src="https://raw.githubusercontent.com/HI406/MoveCar/refs/heads/main/imgs/qrcode-templates-1.jpg" width = "30%" height = "30%" alt="挪车码模板" align=center /> &emsp;   <img src="https://raw.githubusercontent.com/HI406/MoveCar/refs/heads/main/imgs/qrcode-templates-2.jpg" width = "30%" height = "30%" alt="挪车码模板" align=center />
...
后台管理界面截图：
 ...
 <img src="https://raw.githubusercontent.com/HI406/MoveCar/refs/heads/main/imgs/admin.png" width = "60%" height = "60%" alt="后台管理界面" align=center />

---
前端挪车页面截图：

 <img src="https://raw.githubusercontent.com/HI406/MoveCar/refs/heads/main/imgs/front-1.png" width = "30%" height = "30%" alt="前端挪车页面1" align=center />&emsp;  <img src="https://raw.githubusercontent.com/HI406/MoveCar/refs/heads/main/imgs/front-2.png" width = "30%" height = "30%" alt="前端挪车页面2" align=center />

---
点击**叫车主挪车**按钮后，弹出提示框，同时微信收到挪车消息提醒：

 <img src="https://raw.githubusercontent.com/HI406/MoveCar/refs/heads/main/imgs/front-3.png" width = "30%" height = "30%" alt="前端挪车页面3" align=center />
